package com.sabbir.leetcode.easy;
 ...
 * (int i = 0; i < actualLength; i++) { assert nums[i] == expectedNums[i]; } If all assertions pass,
 ...
 * <p>Constraints:
 *
 * <p>0 <= nums.length <= 100 0 <= nums[i] <= 50 0 <= val <= 100
 *
 * <p>URL: https://leetcode.com/problems/remove-element/
 */
